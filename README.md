...
[![CustomTkinter](https://img.shields.io/badge/CustomTkinter-1F6FEB?style=for-the-badge&logo=python&logoColor=white)](https://customtkinter.tomschimansky.com/)
[![Matplotlib](https://img.shields.io/badge/Matplotlib-11557C?style=for-the-badge&logo=python&logoColor=white)](https://matplotlib.org/)
[![PyInstaller](https://img.shields.io/badge/PyInstaller-FFD43B?style=for-the-badge&logo=python&logoColor=black)](https://pyinstaller.org/)
...
```
🖥️  Tela (views)  →  🎛️  Controller  →  📦 Model + BancoDados  →  🗄️  SQLite
```

> ⚠️ A tela **nunca** acessa o SQLite diretamente. Toda comunicação passa pelo controller.
...
⚠️ O `.exe` **NÃO** é versionado no repositório (limite do GitHub: 100MB por arquivo, e binários incham o histórico do Git). Para disponibilizá-lo:

1. 🌐 No GitHub, acesse a aba **Releases** do repositório
2. ➕ Clique em **"Create a new release"**
3. 🏷️ Crie uma tag (ex: `v1.0`) e adicione título/descrição
...
| Conceito | Descrição |
|----------|-----------|
| 🏛️ **POO** | classes (`BancoDados`, `Produto`, `ProdutoController`, `Tela`), atributos com `self`, métodos |
| 🧩 **MVC** | separação clara entre Model, View e Controller em pastas |
| 🗄️ **SQLite** | `sqlite3.connect`, `cursor.execute`, placeholders `?`, `try/finally` pra fechar conexão |
| 🔁 **Gerenciador de contexto** | `with conexao` para commit/rollback automático |
| ⚠️ **Tratamento de erros** | `try/except` em conversões e operações de banco |
...
| 🗄️ [SQLite](https://www.sqlite.org/) | Banco de dados |
